...
def _ensure_parameter_selection_card_expanded(page):
    """Open the Parameter Selection card if not already open.
    ...
    """
    title = page.get_by_text("Parameter Selection").first
