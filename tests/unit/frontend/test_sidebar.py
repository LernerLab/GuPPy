...
def test_sidebar_all_buttons_exist_with_primary_type(sidebar):
    button_names = [
        "save_button",
        "open_storenames",
        "read_rawData",
...
def test_sidebar_progress_bars_initial_values(sidebar):
...
def test_sidebar_attach_callbacks_triggers_function(sidebar):
    calls = []
...
def test_sidebar_add_to_template_populates_sidebar(panel_extension):
