...
def serve_app(*, input_root_folder: str | None = None, output_root_folder: str | None = None) -> None:
    ...
    """
    routes = {
        "/": lambda: build_homepage(input_root_folder=input_root_folder, output_root_folder=output_root_folder),
