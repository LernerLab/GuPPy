...
- Group analysis is now its own optional **Group Analysis** step writing a named `<destination>/<name>_group/` directory, so several groups can coexist and be visualized alongside individual sessions. The **Average Group?** and **Visualize Average Results?** parameters are removed. [PR #446](https://github.com/LernerLab/GuPPy/pull/446)
