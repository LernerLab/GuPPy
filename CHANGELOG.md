...
## Improvements
- Saving on the Label Stores page now shows a **Stores saved** message naming the new run and the next step, and the homepage lists that run under **Output Folder Selection** as soon as it is saved. [PR #504](https://github.com/LernerLab/GuPPy/pull/504)
