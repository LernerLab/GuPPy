...
## Improvements
- Added a [Comparing Two Parameter Sets](https://guppy.readthedocs.io/en/latest/tutorials/compare_parameters.html) tutorial: how to give each parameter set its own named run so a second analysis sits beside the first instead of overwriting it, worked through a narrow vs a wide moving-average filter window. [PR #438](https://github.com/LernerLab/GuPPy/pull/438)
