...
## Features
- Reworked the visualization dashboard's PSTH tab: grouped each plot with its own controls in a labelled card, added per-plot numeric axis-range inputs (typeable min/max that also snap to Bokeh zoom/pan), trace/mean color pickers, a categorical palette selector for the multi-event comparison plot, and an independent save button per plot. Resolves [#253](https://github.com/LernerLab/GuPPy/issues/253). [PR #364](https://github.com/LernerLab/GuPPy/pull/364)
