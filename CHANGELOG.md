...
## Improvements
- Added a [Compare parameter choices on the same session](https://guppy.readthedocs.io/en/latest/how-to/compare-parameters.html) how-to guide: how to give each parameter set its own named run so a second analysis sits beside the first instead of overwriting it, worked through standard vs baseline z-score. [PR #438](https://github.com/LernerLab/GuPPy/pull/438)
