...
## Features
- Added per-plot numeric axis-range inputs (typeable min/max that also snap to Bokeh zoom/pan) and trace/mean color pickers to the visualization dashboard's PSTH tab. Resolves [#253](https://github.com/LernerLab/GuPPy/issues/253). [PR #364](https://github.com/LernerLab/GuPPy/pull/364)
